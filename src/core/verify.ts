...
const actions: Record<string, { tipo: Motivo["tipo"]; responsavel: Motivo["responsavel"]; acao: string }> = {
  ...
  AUT_VENCIDA: { tipo: "corrigir_dado", responsavel: "recepcao", acao: "Conseguir autorizacao que cubra o dia do atendimento. Nao alterar a validade." },
  VALIDADE_ACIMA_DO_MAXIMO: { tipo: "corrigir_dado", responsavel: "recepcao", acao: "Conferir a data de validade digitada." },
