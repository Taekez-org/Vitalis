...
Negacoes, hipotese e pergunta sem fato confirmado nao sao sinais. Na duvida entre rotina e revisar, escolha revisar. Para sinal e revisar, escreva sempre um motivo objetivo, curto e especifico sobre o problema encontrado. Nunca copie nomes, documentos, telefones ou a observacao inteira no motivo.

Responda somente com JSON valido neste formato:
{"classe":"rotina|sinal|revisar","sinais":[],"motivo":""}

Use sinais somente na classe sinal. Para sinal e revisar, motivo e obrigatorio e deve ter no maximo 140 caracteres. Para rotina, motivo deve ser vazio.`;
