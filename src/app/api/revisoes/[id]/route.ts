import { resolveObservationRevisionAsync } from "../../../../infra/store";
...
export async function POST(request: Request, context: { params: Promise<{ id: string }> }) {
  ...
  const resolved = await resolveObservationRevisionAsync(id, body.chave, typeof body.por_quem === "string" && body.por_quem.trim() ? body.por_quem.trim().slice(0, 60) : "Equipe", typeof body.comentario === "string" ? body.comentario : undefined);
