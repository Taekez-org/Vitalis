...
export default function DashboardPage() {
  ...
  return <section className="space-y-7">
    ...
    <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
      ...
      <MetricCard icon={<span className="text-base font-bold">R$</span>} label="Valor em risco" value={money(data.valor_em_risco)} caption="Estimativa das guias pendentes" tone="warning" />
    </div>
    ...
    <div className="grid gap-6 lg:grid-cols-2"><Chart title="Pendências por motivo" values={data.por_codigo} labeler={rotuloMotivo} /><Chart title="Pendências por unidade" values={data.por_unidade} /></div>
